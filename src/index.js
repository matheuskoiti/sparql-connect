 ...
 */
import { 
  buildResourceConnector, resourceCombine
} from 'react-redux-resource'

import {
  buildFetchQuery, buildFetchQuerySmart,
  checkAuthentication as checkAuthenticationRaw,
  setPrefixes, setQueryURL
} from './remote'
...
function checkAuthentication(token) {
  return checkAuthenticationRaw(token)
    .then(isAuth => {
